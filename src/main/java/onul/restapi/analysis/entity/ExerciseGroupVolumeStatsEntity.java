...
@Table(
        ...
        indexes = {
                @Index(name = "idx_member_period_muscle_date", columnList = "member_id, periodType, mainMuscleGroup, startDate"),
                @Index(name = "idx_member_start_date", columnList = "member_id, startDate")
        }
)
@Getter
@NoArgsConstructor
